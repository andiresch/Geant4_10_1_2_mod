...
// ********************************************************************
//
// $Id: G4HadronPhysicsQMD_BIC.cc 83699 2014-09-10 07:18:25Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQMD_BIC
//
// Author: 2006 G.Folger
//
// Based on G4HadronPhysicsQMD_BIC
//
// Modified:
...
#include "G4HadronPhysicsQMD_BIC.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQMD_BIC);

G4ThreadLocal G4HadronPhysicsQMD_BIC::ThreadPrivate*
G4HadronPhysicsQMD_BIC::tpdata = 0;

G4HadronPhysicsQMD_BIC::G4HadronPhysicsQMD_BIC(G4int)
    :  G4VPhysicsConstructor("hInelastic QMD_BIC")
/*    , theNeutrons(0)
    , theFTFPNeutron(0)
    , theQGSPNeutron(0)
    , theBinaryNeutron(0)
...
G4HadronPhysicsQMD_BIC::G4HadronPhysicsQMD_BIC(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQMD_BIC::CreateModels()
{
...
G4HadronPhysicsQMD_BIC::~G4HadronPhysicsQMD_BIC() 
{
  if (!tpdata) return;
...
void G4HadronPhysicsQMD_BIC::ConstructParticle()
{
...
void G4HadronPhysicsQMD_BIC::ConstructProcess()
{
